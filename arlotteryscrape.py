...
def exportARScratcherRecs():
    ...
    while True:
        ...
        try:
            ...
            game_cards = main_content.find_all('div', class_='field field-name-field-ticket-front field-type-image field-label-hidden')
            
            if not game_cards:
                print(f"No games found on page {page}. Done fetching game list.")
                break
