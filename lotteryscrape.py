...
def exportFLScratcherRecs():
    ...
    for s in table['Game Number']:
        ...
        if len(tixdata) == None:
            ...
            tixdata['prizeamount'] = tixdata['prizeamount'].replace({'1000/Week for Life':1000*52*50,'500/Week for Life':500*52*50, '1MM/YR/LF (MIN 25)':1000000*25, '250000YR/LIFE':250000*50}).astype('int')
            tixdata['gameNumber'] = gameNumber
            tixdata['gameName'] = gameName
            tixdata['gamePhoto'] = gamePhoto
            tixdata['price'] = gamePrice
